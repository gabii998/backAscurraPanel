    ...
    schemas: {
      ...
      MercadoPagoConfig: {
        ...
        properties: {
          ...
          backUrlSuccess: { type: "string" },
          backUrlFailure: { type: "string" },
          backUrlPending: { type: "string" },
          apiKeyId:  { type: "string", format: "uuid", nullable: true },
          updatedAt: { type: "string", format: "date-time" },
          createdAt: { type: "string", format: "date-time" },
        },
      ...
      MercadoPagoLog: {
        ...
        properties: {
          ...
          webhookPayload:    { type: "object", nullable: true },
          forwardStatusCode: { type: "integer", nullable: true },
          forwardResponse:   { type: "string" },
          error:             { type: "string" },
          updatedAt:         { type: "string", format: "date-time" },
          createdAt:         { type: "string", format: "date-time" },
        },
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  publicKey:   { type: "string" },
                  mercadoPagoWebhookSecret: { type: "string", description: "Secret de Mercado Pago para validar x-signature entrante" },
